    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        <div class="row mb-2">
            <div class="col-6">
                ...
                <input type="text" name="name" id="name" class="form-control <?php echo (!empty($name_err)) ? 'is-invalid' : ''; ?>" style="background-color: #E8F0FE !important; color: black !important;">
            ...
            <div class="col-6">
                ...
                <input type="text" name="surname" id="surname" class="form-control <?php echo (!empty($surname_err)) ? 'is-invalid' : ''; ?>" style="background-color: #E8F0FE !important; color: black !important;">
                <div class="invalid-feedback">
                    Παρακαλώ συμπληρώστε το κενό.
        ...
        <div class="row mb-2">
            <div class="col-6">
                ...
                <input type="text" name="registration_number" id="registration_number" class="form-control <?php echo (!empty($registration_num_err)) ? 'is-invalid' : ''; ?>" style="background-color: #E8F0FE !important; color: black !important;">
                <div class="invalid-feedback">
                    Παρακαλώ συμπληρώστε το κενό
            ...
            <div class="col-6">
                        ...
                        <input type="date" name="dateOfBirth" id="dateOfBirth" class="form-control <?php echo (!empty($dateOfBirth_err)) ? 'is-invalid' : ''; ?>" style="background-color: #E8F0FE !important; color: black !important;">
                        <div class="invalid-feedback">
                                Παρακαλώ συμπληρώστε το κενό.
        ...
        <div class="row mb-2">
            ...
            <input type="email" name="email" id="email" class="form-control <?php echo (!empty($email_err)) ? 'is-invalid' : ''; ?>" style="background-color: #E8F0FE !important; color: black !important;">
            <div class="invalid-feedback">
                Παρακαλώ συμπληρώστε το κενό
                <?php echo $email_err ?? ''; ?>
            </div>
